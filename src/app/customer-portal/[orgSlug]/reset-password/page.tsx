    ...
    <div className="min-h-[calc(100vh-8rem)] flex items-center justify-center px-4">
      <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-8">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-900">{t('customer.resetPassword.title')}</h1>
          <p className="text-gray-600 mt-2">{t('customer.resetPassword.subtitle')}</p>
        </div>
        ...
        {success ? (
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            >
              {loading ? t('customer.resetPassword.resetting') : t('customer.resetPassword.resetButton')}
            </button>
